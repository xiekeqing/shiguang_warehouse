...
function isLoginPage() {
    ...
    const loginUrl = "http://jwxt.sdnu.edu.cn/jwglxt/xtgl/login_slogin.html";
...
async function fetchAndParseCourses(academicYear, semesterIndex) {
    ...
    // API URL 和请求体
    const xnmXqmBody = `xnm=${academicYear}&xqm=${semesterCode}&kzlx=ck&xsdm=&kclbdm=&kclxdm=`; 
    const url = "http://jwxt.sdnu.edu.cn/jwglxt/kbcx/xskbcx_cxXsgrkb.html?gnmkdm=N253508";
    ...
    const requestOptions = {
        ...
        "refer":"http://jwxt.sdnu.edu.cn/jwglxt/kbcx/xskbcx_cxXskbcxIndex.html?gnmkdm=N253508&layout=default",
        "body": xnmXqmBody,
        "method": "POST",
        "credentials": "include"
    };
